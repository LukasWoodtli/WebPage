...
my_func is called 11 times with the values 10 to 20. That’s usually not what we want.
...
If you call the same loop as above you’ll get calls to my_func with the values:
...
For platform independent code you can #define ENUM_AS_UINT8 : uint8_t
