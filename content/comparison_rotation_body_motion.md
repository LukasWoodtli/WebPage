...
|             | Rotations           | Rigid-Body Motions  |
|-------------|---------------------|---------------------|
| exponential | $so(3) \rarr SO(3)$ | $se(3) \rarr SE(3)$ |
| logarithm   | $SO(3) \rarr so(3)$ | $SE(3) \rarr se(3)$ |

### Exponential

| Rotations                                        | Rigid-Body Motions                      |
|--------------------------------------------------|-----------------------------------------|
| $[\hat\omega]\theta \in so(3) \rarr R \in SO(3)$ | $[S]\theta \in se(3) \rarr T \in SE(3)$ |
...
| Rotations                                                 | Rigid-Body Motions                      |
|-----------------------------------------------------------|-----------------------------------------|
| $R \in SO(3) \rarr [\hat\omega]\theta \in so(3)$          | $T \in SE(3) \rarr [S]\theta \in se(3)$ |
